# Herramientas de Ábaco

**Este archivo se genera solo.** Sale del registro (`abaco_core/nodes/`), así que
...
**Qué hace.** Carga uno de los conjuntos que trae Abaco para aprender y probar.
...
**Qué hace.** Le dice a Abaco cual columna es la fecha y cada cuanto estan medidos los datos.
...
- Abaco no permite dos ejes verticales, a proposito. Dos medidas de escalas distintas van en dos graficos o indexadas a una base comun: con dos ejes se puede elegir la conclusion moviendo las escalas.
...
**Cuándo usarlo.** Al final, cuando el resultado ya se va a usar fuera de Abaco.

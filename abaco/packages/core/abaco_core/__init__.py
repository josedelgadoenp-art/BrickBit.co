"""Abaco — motor de analisis economico sin codigo.
...
no se prueba.
    ...
    from abaco_core import compilar, ejecutar, a_texto, cargar_todos
...
from .codegen.emisor import VERSION_ABACO, Emision, a_texto, emitir
...
__all__ = [
    ...
    "ResultadoEjecucion", "SinCache", "VERSION_ABACO", "__version__", "a_texto",

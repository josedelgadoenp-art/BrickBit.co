"""Exportar: el analisis como un paquete que corre sin Abaco.
...
Este paquete lo genero Abaco. Trae el analisis completo y todo lo que necesita
para volver a correr, sin Abaco de por medio.
...
def requisitos(emision: Emision) -> str:
    ...
    return "\n".join(["# Generado por Abaco a partir de los imports del analisis.", *lineas, ""])

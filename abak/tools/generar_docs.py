...
from abak_core.registry import FAMILIAS, cargar_todos, todos  # noqa: E402
...
def main() -> None:
    cargar_todos()
    l: list[str] = []
    l.append("# Herramientas de Abak")
    l.append("")
    l.append("**Este archivo se genera solo.** Sale del registro (`abak_core/nodes/`), así que")

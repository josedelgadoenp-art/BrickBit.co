...
REDIS = os.environ.get("ABAK_REDIS", "").strip()
EAGER = not REDIS
...
app.conf.update(
    ...
    task_time_limit=int(os.environ.get("ABAK_LIMITE_SEGUNDOS", "900")),
    task_soft_time_limit=int(os.environ.get("ABAK_LIMITE_SEGUNDOS", "900")) - 30,

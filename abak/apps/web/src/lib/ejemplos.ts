...
export const EJEMPLOS: { id: string; titulo: string; descripcion: string; grafo: () => Grafo }[] = [
  {
    ...
    grafo: () => armar('¿Qué explica el precio de la vivienda?', [
      ...
      { id: 'p4', op: 'graficos.tema', etiqueta: 'Títulos', params: { titulo: 'Precio por m² y escolaridad', eje_y: 'Precio por m² (MXN)', nota: 'Fuente: ejemplo de Abak. El precio por m² es una estimación.', modo: 'oscuro' }, x: 60, y: 760 },

 ...
 *
 * Deliberadamente sin biblioteca: la nota metodológica la genera Abak con un
    ...
    <div className="h-full overflow-y-auto p-6">
      <div className="mx-auto max-w-3xl">
        <div className="mb-4 rounded border border-borde bg-superficie px-3 py-2 text-[12px] text-tenue">
          Abak escribe esto a partir de tu lienzo: qué se hizo, con qué supuestos, con qué

...
escrito que se hizo, con que supuestos y con que advertencias. Abak lo escribe
...
def nota_metodologica(programa: Programa, *, autor: str | None = None,
    ...
    lineas.append(f"*Generada por Abak el {hoy}"
    ...
    if estimadas:
        ...
        lineas.append("Las siguientes columnas **no son mediciones**: salieron de un modelo, un "
                      ...
                      "de Abak hay que decir que son estimaciones.")
        lineas.append("")
